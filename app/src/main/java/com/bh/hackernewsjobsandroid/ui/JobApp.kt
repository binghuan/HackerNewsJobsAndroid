...
fun JobApp(viewModel: JobViewModel) {
    ...
    Column(
        ...
        CenterAlignedTopAppBar(
            title = { Text("Hacker News Jobs", color = Color.White) },
            actions = {
                IconButton(
                    onClick = { viewModel.fetchAndStoreJobs() },
            ...
            colors = TopAppBarDefaults.centerAlignedTopAppBarColors(
                containerColor = Color(0xFF6200EE) // Set your desired background color here
            )
        )
